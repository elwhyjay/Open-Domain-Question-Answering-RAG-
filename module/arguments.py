...
class DataTrainingArguments:
    ...
    num_neg: int = field(default=2, metadata={"help": "Define how many negative passage per question."})
    which_retrieval: str = field(default="dense", metadata={"help": "dense or sparse"})
